...
HOOK_INLINE size_t _LIB_path_join_3(_ROSE_PATH_JOIN_ARGS_1);
HOOK_INLINE size_t _LIB_path_join_4(_ROSE_PATH_JOIN_ARGS_2);
HOOK_INLINE size_t _LIB_path_join_5(_ROSE_PATH_JOIN_ARGS_3);
HOOK_INLINE size_t _LIB_path_join_6(_ROSE_PATH_JOIN_ARGS_4);
HOOK_INLINE size_t _LIB_path_join_7(_ROSE_PATH_JOIN_ARGS_5);
HOOK_INLINE size_t _LIB_path_join_8(_ROSE_PATH_JOIN_ARGS_6);
HOOK_INLINE size_t _LIB_path_join_9(_ROSE_PATH_JOIN_ARGS_7);
...
#include "intern/path_utils_inline.c"
